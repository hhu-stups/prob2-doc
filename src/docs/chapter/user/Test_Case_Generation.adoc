...
....
./probcli.sh simplecounter.mch -cbc_tests 5 count=MAX-1 test_results.xml -cb_cover Increase -p CLPFD true -p TIME_OUT 2000
....
...
in which case no file is generated.::
