...
/Image:disprover-all.png[Image:disprover-all.png]: The proof obligation
editor in Rodin presents the user with a number of Hypotheses and one
...
/File:disprover_proof.png[File:disprover_proof.png]
