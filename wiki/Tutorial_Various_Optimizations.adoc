...
/file:RelationFigureExplanation.png[file:RelationFigureExplanation.png]
...
* /file:_GuaranteedRelation.png[file: GuaranteedRelation.png] +
`Op2` is *always* enabled after the execution of `Op1`
* /file:_ImpossibleRelation.png[file: ImpossibleRelation.png] +
`Op2` is *impossible* to be enabled after the execution of `Op1`
* /file:_KeepRelation.png[file: KeepRelation.png] +
`Op1` *keeps* `Op2` enabled respectively disabled
...
/File:StateSpacePGE.png[File:StateSpacePGE.png]
...
|Enter1 | impossible | impossible | guaranteed | keep | impossible |
keep
...
|Enter2 | keep | impossible | keep | impossible | impossible |
guaranteed
...
/_file:_StateSpaceDepthFirst.png_[ file: StateSpaceDepthFirst.png ]
...
/_file:_StateSpaceBreadthFirst.png_[ file: StateSpaceBreadthFirst.png ]
...
/_file:_PGEEvaluationTable.png_[ file: PGEEvaluationTable.png ]
